package fr.ethan.cachecache.Utils.ActionBarAPI;
...
public class ActionBarAPI extends JavaPlugin implements Listener {
    ...
    public static void sendActionBar(Player player, String message) {
        ...
        try {
            Object packet;
            Class<?> craftPlayerClass = Class.forName("org.bukkit.craftbukkit.v1_15_R1.entity.CraftPlayer"/*"org.bukkit.craftbukkit." + nmsver + ".entity.player"*/);
            Object craftPlayer = craftPlayerClass.cast(player);
            Class<?> packetPlayOutChatClass = Class.forName("net.minecraft.server.v1_15_R1.PacketPlayOutChat"/*"net.minecraft.server." + nmsver + ".PacketPlayOutChat"*/);
            Class<?> packetClass = Class.forName("net.minecraft.server.v1_15_R1.Packet"/*"net.minecraft.server." + nmsver + ".Packet"*/);
            if (useOldMethods) {
                Class<?> chatSerializerClass = Class.forName("net.minecraft.server.v1_15_R1.ChatSerializer"/*"net.minecraft.server." + nmsver + ".ChatSerializer"*/);
                Class<?> iChatBaseComponentClass = Class.forName("net.minecraft.server.v1_15_R1.IChatBaseComponent"/*"net.minecraft.server." + nmsver + ".IChatBaseComponent"*/);
                ...
                Class<?> chatComponentTextClass = Class.forName("net.minecraft.server.v1_15_R1.ChatComponentText"/*"net.minecraft.server." + nmsver + ".ChatComponentText"*/);
                Class<?> iChatBaseComponentClass = Class.forName("net.minecraft.server.v1_15_R1.IChatBaseComponent"/*"net.minecraft.server." + nmsver + ".IChatBaseComponent"*/);
                try {
                    Class<?> chatMessageTypeClass = Class.forName("net.minecraft.server.v1_15_R1.ChatMessageType"/*"net.minecraft.server." + nmsver + ".ChatMessageType"*/);
